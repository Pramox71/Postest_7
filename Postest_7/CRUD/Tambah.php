<?php
    ...
    if(isset($_POST['tambah'])){
        ...
        if (move_uploaded_file($tmp, 'img/'.$gambar_new)){
            $sql = "INSERT INTO data_kapal VALUES ('','$nama', '$jenis', '$banyak_abk', '$gambar_new','$tahun')";
...
<body>
    ...
    <div class="kotak_tambah">
        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <input type="text" name="nama" class="form_tambah" placeholder="Masukkan Nama Kapal" required>
    
            <label>Jenis Kapal</label>
            <input type="text" name="jenis" class="form_tambah" placeholder="Jenis Kapal" required>

            <label>Jumlah ABK</label>
            <input type="number" name="banyak_abk" class="form_tambah" placeholder="Banyak ABK" required>

            <label>Gambar Kapal</label>
            <input type="file" name="kapal" class="form_tambah" accept="image/*" required>
