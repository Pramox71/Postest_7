...
tombolPesan.addEventListener("click", function (e) {
  ...
  if (nama.value == "" || destinasi.value == "" || status.value == "" || jumlah.value == "") {
    ...
    // Mengecek inputan destinasi sesuai 2 Pilihan: Balikpapan, atau Penajam
    if (destinasi.value == "Balikpapan") {
      document.getElementById("destinasiOutput").innerText = destinasi.value;
    } else if (destinasi.value == "Penajam") {
      document.getElementById("destinasiOutput").innerText = destinasi.value;
    } else {
      alert("Pilihan Destinasi hanya Balikpapan, atau Penajam");
    }
    ...
    if (destinasi.value == "Balikpapan" && status.value == "Dewasa") {
      harga = 200000;
      hargaPerTiket.innerText = harga + " (Dua Ratus Ribu)";
    } else if (destinasi.value == "Balikpapan" && status.value == "Anak-anak") {
      harga = 100000;
      hargaPerTiket.innerText = harga + " (Seratus Ribu)";
    } else if (destinasi.value == "Penajam" && status.value == "Dewasa") {
      harga = 300000;
      hargaPerTiket.innerText = harga + " (Tiga Ratus Ribu)";
    } else if (destinasi.value == "Penajam" && status.value == "Anak-anak") {
      harga = 200000;
      hargaPerTiket.innerText = harga + " (Dua Ratus Ribu)";
    } 
